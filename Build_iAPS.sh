...
if [ -z "$CUSTOM_BRANCH" ]; then
    while [ -z "$BRANCH" ]; do
        ...
        echo -e ""
        echo -e "The Loop and Learn team that created this build script suggest you consider"
        echo -e "building Open-iAPS instead. Please read about this alternative here:"
        echo -e "  insert link here once public"
        echo -e ""
        echo -e "If you decide to stay with iAPS, please pay close attention to the discord conversation"
        echo -e ""
